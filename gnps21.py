...
def rootw1():
    ...
    def signUp():
        try:
            ...
            try:
                label6.grid_remove(), label7.grid_remove(), label8.grid_remove(), user_idvalue.grid_remove(), pwvalue.grid_remove(), btn3.  grid_remove(), radio1.grid_remove(), radio2.grid_remove(), radio3.grid_remove(), radio4.grid_remove(), radio5.grid_remove(),  radio6.grid_remove(), btn4.grid_remove(), label9.grid_remove(), label10.grid_remove(), label11.grid_remove(), label12.grid_remove(), label13.grid_remove(), label14.grid_remove(), entry6.grid_remove(), entry7.grid_remove(), entry8.grid_remove(), entry9.grid_remove(), entry10.grid_remove(), entry11.grid_remove(), btn5.grid_remove()
            except:
                pass
                                ...
                                if var.get() != 0:
                                    ...
                                    if var.get() == 1:
                                        ...
                                        try:  # Removing grids of option 2
                                            radio7.grid_remove(), radio8.grid_remove(), radio9.grid_remove(), radio10.grid_remove(), radio11.grid_remove(), radio12.grid_remove(), btn7.grid_remove()
                                        except:
                                            pass
                                        try:
                                            entry12.grid_remove(), entry13.grid_remove(), label15.grid_remove(), label16.grid_remove(), btn6.grid_remove()
                                        except:
                                            pass
                                            ...
                                            if name.get() == "" or admn_no.get() == "":
                                                ...
                                                if res == []:
                                                    ...
                                                    try:
                                                        ...
                                                        if v == "yes":
                                                            msg.showinfo("Delete", "The Data was Sucessfully Deleted")
                                                            execute_query(cd, q1)
                                                    except:
                                                        print("Error")
    ...
    # Entries
    serv_passvalue = Entry(root, textvariable=serv_pass,
                           font="conicsans 10 bold")
    serv_passvalue.grid(row=1, column=1)
    btn1 = Button(root, text="Submit", command=submitg,
                  fg="purple", font="conicsans 10 bold")
