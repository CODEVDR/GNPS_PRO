...
def rootw1():
    ...
    def signUp():
        try:
            ...
            pwvalue_sign_up = Entry(
                root, textvariable=pw_sign_up, font="conicsans 10 bold", show="*")
    ...
    def signIn():
                            ...
                            def storevals():
                                ...
                                if var.get() != 0:
                                    ...
                                    if var.get() == 1:
                                        ...
                                        radio12 = Radiobutton(
                                            root, text="Update Admission Number", padx=1, variable=var1, value=6, font="conocsans 10 bold")
                                        radio12.grid(row=9, column=0)
        ...
        try:
            ...
            pwvalue = Entry(root, textvariable=pw,
                            font="conicsans 10 bold", show="*")
